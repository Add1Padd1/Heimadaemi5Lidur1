...
// SNÚA MEÐ MÚS O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/
...
window.onload = function init() {
  ...
  // EVENT HLUSTENDUR FYRIR MÚSINA O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/
...
function render() {
  ...
  var mv = mat4();
  // MÍN BÆTING O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/O/
  ...
  switch (view) {
    case 1:
      ...
      mv = lookAt(
        vec3(250.0 + spinX, spinY, 100.0 + height),
        vec3(0.0, 0.0, 0.0),
        vec3(0.0, 0.0, 1.0)
      );
      drawScenery(mv);
    ...
    case 8:
      ...
      break;
    case 9:
      // Above house, following car
      mv = lookAt(
        vec3(-40.0, 140.0, 100.0 + height),
        vec3(carXPos, carYPos, 0.0),
        vec3(0.0, 0.0, 1.0)
      );
      drawScenery(mv);
